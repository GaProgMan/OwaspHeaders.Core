                ...
                secureHeadersLogging = new
                {
                    ...
                    features =
                        new[]
                        {
                            ...
                            "Warning logs for configuration issues", "Error logs for validation failures",
                    ...
                    defaultEventIdRanges =
                        new { information = "1000-1999", warning = "2000-2999", error = "3000-3999" },
                    customization =
                        new
                        {
                            baseEventId = "Use WithLoggingEventIdBase(baseId) to offset all Event IDs",
                            customEventIds =
                                "Use WithLoggingEventIds(config) for full control over individual Event IDs"
                        }
                },
                endpoints = new
                {
