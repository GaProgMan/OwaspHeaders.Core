...
namespace OwaspHeaders.Core.Extensions
{
    ...
    public static class SecureHeadersMiddlewareExtensions
    {
        ...
        /// an instance of an <see cref="IApplcationBuilder" />.
        ...
        public static IApplicationBuilder SecureHeadersMiddleware(this IApplicationBuilder builder, SecureHeadersMiddlewareConfiguration config)
        {
